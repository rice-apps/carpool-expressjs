...
if (process.env.NODE_ENV === 'testaaa') {
  ...
  module.exports = {
    secret: 'TEST_SECRET',
    db_uri: 'mongodb://carpool2018:carpool2018@ds147723.mlab.com:47723/carpool-dev1',  // database for testing
    // db_uri: 'mongodb://carpool2018:carpool2018@ds149353.mlab.com:49353/carpool_dev',  // actual database
